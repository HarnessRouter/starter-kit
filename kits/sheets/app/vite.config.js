...
// The template library is kit data, not app data — it lives at kits/sheets/templates/ and is the
// one copy. Staging it into public/ at build time is what makes it reachable at
// /kits/sheets/templates.json without committing a second copy of it.
