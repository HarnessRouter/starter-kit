...
export const LINKS = {
  ...
  // Sheets README and its skill, not a list of every starter kit.
  docs: 'https://github.com/HarnessRouter/starter-kit/tree/main/kits/sheets',
};
  ...
  return (
    <>
      ...
      <Popover open={open} anchorRef={btnRef} onClose={() => setOpen(false)}
        ...
        <div className="sh-who">{displayName}</div>
        <a className="uic-pop-item" href={LINKS.docs} target="_blank" rel="noreferrer">
          <BookOpen size={15} />Documentation
        </a>
        {session.gated && (
          <button type="button" className="uic-pop-item sh-danger" onClick={logout}>
