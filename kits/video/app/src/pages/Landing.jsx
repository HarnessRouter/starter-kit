...
import {
  listTemplates, templatePreview, templateReference, templateShots,
} from '../lib/templates';
...
function TemplateArt({ template }) {
  ...
  const ref = templateReference(template);
  if (ref) {
    return (
...
export function LandingPage() {
  ...
  function start() {
    ...
    stageReference(id, templateReference(tpl));
      ...
      {preview && (
        ...
        >
          <div className="vd-preview">
            {templateReference(preview) && (
              <figure className="vd-preview-ref">
                <img src={templateReference(preview).src}
                     alt={templateReference(preview).alt || ''} />
                <figcaption>
